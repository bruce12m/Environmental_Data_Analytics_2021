...
NTL.phys.data.Tuesday90s <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 %in% (1990:1999))

```
Question: Why don't we filter using row numbers?

> Answer: Not as reproducable 
...
NTL.phys.data.irradiance <- NTL.phys.data %>% 
