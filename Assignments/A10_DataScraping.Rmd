...
ggplot(thedf,aes(x=Month,y=maximum_withdrawl_MGD)) + 
  geom_point() +
  labs(title = "2015 Water Withdrawals for Durham",
    #title = paste(YearChar, "Water withdrawals for", PSWID),
       y = "Withdrawal (mgd)",
       x = "Month")
#  labs(title = paste0(year,"Water Withdrawals for",PSWID),
#       y="Withdrawal (mgd)",
#       x="Month")
