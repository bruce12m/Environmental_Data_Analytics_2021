...
> Answer: Both options "worked", though only the ifelse approach iterated through all 4 entries of the vector and outputs the results into a new vector. Basically, if/else doesn't play nicely with vectors, while ifelse does. 
