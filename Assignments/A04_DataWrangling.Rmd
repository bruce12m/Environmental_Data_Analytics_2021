...
EPAair_O3_NC_2019 <- read.csv("C:/Users/mmb88/Desktop/Environmental_Data_Analytics_2021/Data/Raw/EPAair_O3_NC2019_raw.csv")
EPAair_O3_NC_2018 <- read.csv("C:/Users/mmb88/Desktop/Environmental_Data_Analytics_2021/Data/Raw/EPAair_O3_NC2018_raw.csv")
EPAair_PM25_NC_2019 <- read.csv("C:/Users/mmb88/Desktop/Environmental_Data_Analytics_2021/Data/Raw/EPAair_PM25_NC2019_raw.csv")
EPAair_PM25_NC_2018 <- read.csv("C:/Users/mmb88/Desktop/Environmental_Data_Analytics_2021/Data/Raw/EPAair_PM25_NC2018_raw.csv")
...
#11 Save your processed dataset with the following file name: "EPAair_O3_PM25_NC1718_Processed.csv"
write.csv(EPAair_NC_piped_spread, row.names = FALSE, file ="C:/Users/mmb88/Desktop/Environmental_Data_Analytics_2021/Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv")
...
> Answer: na.omit is general; removes rows with NA values in ANY column, even if you try to specify a particular column. Meanwhile, drop_na is targeted; it allows users to specify the column where it should search and then drops rows where the NAs are present in that specified column. In our instance, running the na.omit function returns a dataframe with dimensions 101 by 5, meaning that, as predicted, it removed a lot more rows. 
